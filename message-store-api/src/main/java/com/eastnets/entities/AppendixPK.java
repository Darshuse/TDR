...
public class AppendixPK implements Serializable {
	...
	public AppendixPK(long aid, long appeSUmidh, long appeSUmidl, long appeInstNum, Date appeDateTime,
			long appeSeqNbr) {
		super();
		this.aid = aid;
	...
	public String toString() {
		return "AppendixPK [aid=" + aid + ", appeSUmidh=" + appeSUmidh + ", appeSUmidl=" + appeSUmidl + ", appeInstNum="
				+ appeInstNum + ", appeDateTime=" + appeDateTime + ", appeSeqNbr=" + appeSeqNbr + "]";
	}

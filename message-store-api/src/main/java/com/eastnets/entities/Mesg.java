...
public class Mesg implements Serializable {
	...
	private LocalDateTime mesgCreaDateTime;
	...
	private LocalDateTime mesgModDateTime;
	...
	private Long mesgUumidSuffix;

	@Column(name = "MESG_VALIDATION_PASSED")
	private String mesgValidationPassed = "VAL_NO_VALIDATION";
	...
	private Double xFinAmount = null;
	...
	private LocalDate xFinValueDate = null;
	...
	@Column(name = "X_INST0_RP_NAME")
	private String xInst0RpName;

	// @OneToOne(mappedBy = "mesg", cascade = CascadeType.ALL, fetch =
	// FetchType.EAGER, targetEntity = Text.class)
	// private Text text;

	@OneToMany(mappedBy = "mesg", cascade = CascadeType.ALL)
	...
	@JoinColumns({
			@JoinColumn(name = "MESG_TYPE", referencedColumnName = "MESG_TYPE", insertable = false, updatable = false) })
	...
	public LocalDateTime getMesgCreaDateTime() {
		return mesgCreaDateTime;
	}

	public void setMesgCreaDateTime(LocalDateTime mesgCreaDateTime) {
	...
	public LocalDateTime getMesgModDateTime() {
		return mesgModDateTime;
	}

	public void setMesgModDateTime(LocalDateTime mesgModDateTime) {
	...
	public PKMesg getMsgId() {
		return msgId;
	}

	public void setMsgId(PKMesg msgId) {
		this.msgId = msgId;
	}
	...
	public Long getMesgUumidSuffix() {
		return mesgUumidSuffix;
	}

	public void setMesgUumidSuffix(Long mesgUumidSuffix) {
	...
	public LocalDate getxFinValueDate() {
		return xFinValueDate;
	}

	public void setxFinValueDate(LocalDate xFinValueDate) {

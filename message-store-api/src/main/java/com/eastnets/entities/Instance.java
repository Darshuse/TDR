...
public class Instance implements Serializable {
	...
	private LocalDateTime instAppeDateTime;
	...
	private LocalDateTime instCreaDateTime;
	...
	private LocalDateTime instDeferredTime = null;
	...
	private double instSm2000Priority;
	...
	public LocalDateTime getInstAppeDateTime() {
		return instAppeDateTime;
	}

	public void setInstAppeDateTime(LocalDateTime instAppeDateTime) {
	...
	public LocalDateTime getInstCreaDateTime() {
		return instCreaDateTime;
	}

	public void setInstCreaDateTime(LocalDateTime instCreaDateTime) {
	...
	public LocalDateTime getInstDeferredTime() {
		return instDeferredTime;
	}

	public void setInstDeferredTime(LocalDateTime instDeferredTime) {
	...
	public double getInstSm2000Priority() {
		return instSm2000Priority;
	}

	public void setInstSm2000Priority(double instSm2000Priority) {

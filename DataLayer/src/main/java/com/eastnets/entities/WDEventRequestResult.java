...
public class WDEventRequestResult extends WDSearchResult {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "eventResultSeq")
	@SequenceGenerator(name = "eventResultSeq", sequenceName = "WDEVENTREQUESTRESULT_ID", allocationSize = 1)
	@Column(name = "ID")
	private Integer id;
	...
	public String toString() {
		return "WDEventRequestResult [id=" + id + ", aid=" + aid + ", jrnlRevDateTime=" + jrnlRevDateTime
				+ ", jrnlSeqNumber=" + jrnlSeqNumber + ", requestId=" + requestId + ", description=" + description
				+ ", username=" + username + ", processed=" + processed + ", insertTime=" + insertTime + "]";
	}

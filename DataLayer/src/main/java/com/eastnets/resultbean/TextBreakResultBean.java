...
public class TextBreakResultBean {
	...
	public TextBreakResultBean(Date mesgCreaDateTime, Integer aid, Integer umidl, Integer umidh, String mesgType,
			String mesgSyntaxTableVer, String textDataBlock) {
		super();

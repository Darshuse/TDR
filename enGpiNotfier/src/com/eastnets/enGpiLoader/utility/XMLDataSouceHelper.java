...
public class XMLDataSouceHelper implements Serializable {
	...
	public void initDBViewConfig(String ip, String dbType, String dbName, String serviceName, String port, String username, String password,String instansName,boolean partitioned,DataSource dataSource ) {
		this.ipView = ip;
	...
	public void initDBConfig(String ip, String dbType, String dbName, String serviceName, String port, String username, String password,String instansName,String aid,boolean partitioned,DataSource dataSource ) {
		this.ip = ip;
		this.dbType = dbType;
		this.dbName = dbName;
	...
	public void initIbmMqConfig(String ibmMqIp, String ibmMqUsername, String ibmMqPassword, String ibmMqPort, 
			String ibmChannel, String ibmQueueManager, String ibmInputQueueName, String ibmErrorQueueName,DataSource dataSource  ) {
	...
	public String toString() {
		return "XMLDataSouce [ip=" + ip + ", dbType=" + dbType + ", dbName=" + dbName + ", serviceName=" + serviceName + ", port=" + port + ", username=" + username
				+ ", password=" + password + ", Bulk Size = " + "" + "]";
	}

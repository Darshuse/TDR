 ...
 *  
 *  
 *  This Line was added just for test auto build
 *  
 */
@RunWith(DataDrivenTestRunner.class)
@DataLoader(filePaths = "Test_Files/Admin_Test.xls", loaderType = LoaderType.EXCEL)
public class AdminTestAdding extends BaseAppTest {
	...
	/*
	 * BIC should be a valid BIC (8 characters and end with zero '0')
	 * If the BIC already exists an exception would be thrown
	 * 
	 */

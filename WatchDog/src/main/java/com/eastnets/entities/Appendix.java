...
public class Appendix implements Serializable {
	...
	public String toString() {
		return "Appendix [id=" + id + ", appeAckNackLauResult=" + appeAckNackLauResult + ", appeAckNackText=" + appeAckNackText + ", appeAnswerback=" + appeAnswerback + ", appeAuthResult=" + appeAuthResult + ", appeAuthValue=" + appeAuthValue
				...
				+ ", appeRemoteInputReference=" + appeRemoteInputReference + ", appeRemoteInputTime=" + appeRemoteInputTime + ", appeRespAuthResult=" + appeRespAuthResult + ", appeRespCbtReference=" + appeRespCbtReference + ", appeRespNonrepType="
				+ appeRespNonrepType + ", appeRespNonrepWarning=" + appeRespNonrepWarning + ", appeRespPossibleDupCrea=" + appeRespPossibleDupCrea + ", appeRespResponderDn=" + appeRespResponderDn + ", appeRespSignerDn=" + appeRespSignerDn
				+ ", appeResponseRef=" + appeResponseRef + ", appeRmaCheckResult=" + appeRmaCheckResult + ", appeSenderCancelStatus=" + appeSenderCancelStatus + ", appeSenderSwiftAddress=" + appeSenderSwiftAddress + ", appeSequenceNbr="
				+ appeSequenceNbr + ", appeSessionHolder=" + appeSessionHolder + ", appeSessionNbr=" + appeSessionNbr + ", appeSignerDn=" + appeSignerDn + ", appeSnfDelvNotifReq=" + appeSnfDelvNotifReq + ", appeSnfInputTime=" + appeSnfInputTime
				+ ", appeSnfQueueName=" + appeSnfQueueName + ", appeSnlEndpoint=" + appeSnlEndpoint + ", appeSwiftRef=" + appeSwiftRef + ", appeSwiftRequestRef=" + appeSwiftRequestRef + ", appeSwiftResponseRef=" + appeSwiftResponseRef
				+ ", appeTelexBatchSequence=" + appeTelexBatchSequence + ", appeTelexDuration=" + appeTelexDuration + ", appeTelexNumber=" + appeTelexNumber + ", appeTnapName=" + appeTnapName + ", appeToken=" + appeToken + ", appeTransmissionNbr="
				+ appeTransmissionNbr + ", appeType=" + appeType + ", appeUsePkiSignature=" + appeUsePkiSignature + ", xAppeLast=" + xAppeLast + ", rinst=" + rinst + "]";
	}

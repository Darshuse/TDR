...
public class MessageDetails extends BaseEntity {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7605480524354533660L;
	private Integer aid;
	...
	private String instMessageCreator;
	private String instMessageContext;
	private String mesgServiceURI;
	private String mesgTypeURI;
	private String mesgRequestType;
	private String instCBTReference;
	private String instIsNRRequested;
	private String mesgExpiryDateTime;
	...
	private String allSenderChargeAmount;
	private String allSenderChargeCur;
	...
	public String getAllSenderChargeAmount() {
		return allSenderChargeAmount;
	}

	public void setAllSenderChargeAmount(String allSenderChargeAmount) {
		this.allSenderChargeAmount = allSenderChargeAmount;
	}

	public String getAllSenderChargeCur() {
		return allSenderChargeCur;
	}

	public void setAllSenderChargeCur(String allSenderChargeCur) {
		this.allSenderChargeCur = allSenderChargeCur;
	}
	...
	public String getInstructedAmountFormatted() {
		if (instructedAmount == null)
			return "";
		/*
		 * if (instructedAmount.toString().endsWith(".00")) return instructedAmount.toString().substring(0, instructedAmount.toString().length() - 3);
		 */
	...
	public String getMesgCreaDateTimeWithZoneStr() {
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss 'GMT'X");
		String format = sdf.format(mesgCreaDateTime);
		return format;
	}
	...
	public String getInstMessageCreator() {
		return instMessageCreator;
	}

	public void setInstMessageCreator(String instMessageCreator) {
		this.instMessageCreator = instMessageCreator;
	}

	public String getInstMessageContext() {
		return instMessageContext;
	}

	public void setInstMessageContext(String instMessageContext) {
		this.instMessageContext = instMessageContext;
	}

	public String getMesgServiceURI() {
		return mesgServiceURI;
	}

	public void setMesgServiceURI(String mesgServiceURI) {
		this.mesgServiceURI = mesgServiceURI;
	}

	public String getMesgTypeURI() {
		return mesgTypeURI;
	}

	public void setMesgTypeURI(String mesgTypeURI) {
		this.mesgTypeURI = mesgTypeURI;
	}
	...
	public String getInstIsNRRequested() {
		return instIsNRRequested;
	}

	public void setInstIsNRRequested(String instIsNRRequested) {
		this.instIsNRRequested = instIsNRRequested;
	}

	public String getMesgExpiryDateTime() {
		return mesgExpiryDateTime;
	}

	public void setMesgExpiryDateTime(String mesgExpiryDateTime) {
		this.mesgExpiryDateTime = mesgExpiryDateTime;
	}

 ...
 */
public class JournalMapperOracle implements Serializable, RowMapper<SearchResultEntity> {

		/**
	 * 
	 */
	private static final long serialVersionUID = 3520715827672100364L;
		...
		public SearchResultEntity mapRow(final ResultSet rs, final int rowNum)
			...
			String descStr1 = descStr != null ? descStr.toString().replaceAll("\\\\n", separator).replace("\\r", "") : " " ;

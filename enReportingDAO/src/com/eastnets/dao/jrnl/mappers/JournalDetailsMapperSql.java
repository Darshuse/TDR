...
public class JournalDetailsMapperSql implements Serializable, RowMapper<DetailsEntity>{
	/**
	 * 
	 */
	private static final long serialVersionUID = -3065941156523340290L;
	...
	public DetailsEntity mapRow(final ResultSet rs, final int rowNum)
			...
			StringBuffer descStr1 = new StringBuffer(str != null ? str.toString().replaceAll("\\\\n", separator ).replace("\\r", "") : " ") ;

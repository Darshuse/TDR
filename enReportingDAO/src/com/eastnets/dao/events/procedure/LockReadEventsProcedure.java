package com.eastnets.dao.events.procedure;
...
public class LockReadEventsProcedure extends StoredProcedure implements Serializable {
	...
	/*
	 * This procedure will lock after read the records in order to prevent any
	 * overlap that may happened in cluster mode
	 */

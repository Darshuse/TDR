 ...
 */
public class AdminInsertConnectionProcedure extends StoredProcedure implements Serializable {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 6542440517668188380L;
	private static final String PROCEDURE_NAME = "ldAddNewConnection";

	@ConstructorProperties("jdbcTemplate")
	@Inject
	public AdminInsertConnectionProcedure(JdbcTemplate jdbcTemplate) {

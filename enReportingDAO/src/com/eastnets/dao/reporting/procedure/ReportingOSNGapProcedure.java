 ...
 * @since July 11, 2012
 */
public class ReportingOSNGapProcedure  extends StoredProcedure implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = 416970120918010617L;
	private static final String PROCEDURE_NAME = "repOSNGap";
	public ReportingOSNGapProcedure(JdbcTemplate jdbcTemplate) {

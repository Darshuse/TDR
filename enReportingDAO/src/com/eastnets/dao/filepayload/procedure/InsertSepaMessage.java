...
public class InsertSepaMessage extends StoredProcedure implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private static final String PROCEDURE_NAME = "ldProcessSepa";
	
	public InsertSepaMessage(JdbcTemplate jdbcTemplate) {
		...
		declareParameter(new SqlParameter("xmltext_data", Types.VARCHAR));
	...
	public int execute(final FilePayload filePayload, String mesgText , String mesgId, int mesgOrder , int mesgSize, int blkFlag) {

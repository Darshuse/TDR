...
public class XMLNotifierConfigHelper {
	...
	private boolean enabelUC;

	public XMLNotifierConfigHelper(String filePathDirectory, String tableName, String where, String filePathRJE, List<Queue> queueList, boolean enabelMailNotify, boolean enabelWriteGpiConfirmation, Integer timeInterval, Integer bulkSize,
			Map<String, Queue> queueMap, long sleepPeriod, String rejex, String environmentType, String delegatBic, Integer mailAttempts, Integer confirmAttempts, String durationTime, String mesgDirection, String reasonCode, String settlementMethod,
			String statusCode, boolean enabelUC) {
	...
	public boolean isEnabelUC() {
		return enabelUC;
	}

	public void setEnabelUC(boolean enabelUC) {
		this.enabelUC = enabelUC;
	}

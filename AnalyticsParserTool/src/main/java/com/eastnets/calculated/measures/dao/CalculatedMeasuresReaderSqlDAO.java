...
@Repository
public class CalculatedMeasuresReaderSqlDAO implements CalculatedMeasuresReaderDAO {

	private static final Logger LOGGER = LogManager.getLogger(CalculatedMeasuresReaderSqlDAO.class);
	...
	public String generateMessageSummayQuery() {
		...
		try {
			...
			query.append("SELECT M.AID,M.MESG_S_UMIDL,M.MESG_S_UMIDH,M.MESG_TYPE,M.MESG_SENDER_X1 ,"
					...
					+ "from ((SELECT TOP " + globalConfiguration.getAnalyticsParserDetailsBulkSize());
			query.append(" AID,MESG_S_UMIDL,MESG_S_UMIDH,MESG_TYPE,MESG_SENDER_X1 ,X_RECEIVER_X1,"
					+ "MESG_SUB_FORMAT,MESG_CREA_DATE_TIME FROM MESG_SUMMARY where ");
